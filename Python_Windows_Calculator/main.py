...
DIGIT_FRONT_STYLE=("Arial",24,"bold")
...
class Calculator:
    ...
    def create_display_labels(self):
        ...
        font=SMALL_FRONT_STYLE)
        total_label.pack(expand=True,fill="both")


        #current expression
        label=tk.Label(self.display_frame,text=self.total_expression,anchor=tk.E,bg=LIGHT_GRAY,fg=LABEL_COLOR,padx=24,
    ...
    def create_digit_button(self):
        for digit,grid_value in self.digits.items():
            button=tk.Button(self.button_frame,text=str(digit),bg=WHITE,fg=LABEL_COLOR,font=DIGIT_FRONT_STYLE,
